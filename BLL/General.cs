...
namespace BLL
{
    public class General
    {
        ...
        {
            public static string Login = "Log_Table";
            public static string User = "T_User";
            public static string Address = "Address";
            public static string Ads = "Ads";
            public static string Category = "Category";
            public static string Comment = "Comment";
            public static string Contact = "Contact";
            public static string Logo = "FavLogoTitle";
            public static string Meta = "Meta";
            public static string Post = "Post";
            public static string Image = "PostImage";
            public static string Tag = "PostTag";
            public static string Video = "Video";
            public static string Social = "SocialMedia";
        }
